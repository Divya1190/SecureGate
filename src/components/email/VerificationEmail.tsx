      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Text style={paragraph}>
            Thank you for registering with SecureGate. Please verify your email
            address by clicking the secure button below:
          </Text>
          ...
          <Text style={paragraph}>
            This link will expire in 15 minutes and can only be used once. If
            you did not request this, you can safely ignore this email.
          </Text>
          <Text style={footer}>
